        ...
        <div className="section-inner">
          <div className="about-panel glass reveal">
            ...
            <div className="about-copy">
              ...
              <p>
                <b>FMSMP</b> یک <b>سرور ماینکرفت فارسی</b> است که سیستم‌های صنعتی اسلایم‌فان را با هیجان و اقتصاد
                سبک DonutSMP پیوند می‌زند. از یک ماشین ساده شروع کن، خط تولید بساز، بازار را در دست بگیر و جایگاهت
                را در جدول برترین‌ها تثبیت کن. با Voice Mod همان لحظه با بازیکنان نزدیک صحبت می‌کنی؛ تجربه‌ای
                زنده‌تر، صمیمی‌تر و واقعی‌تر.
              </p>
              <p>
